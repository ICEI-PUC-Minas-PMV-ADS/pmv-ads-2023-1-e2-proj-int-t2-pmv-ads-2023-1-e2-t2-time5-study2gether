...
| **ID** | **Descrição do teste** | **Descrição do resultado** | **Gravidade** |
|:---: |:---: |:---: |:---: |
| CT-16.1 - RF-05 | Verificar se a busca de perguntas por palavra chave digitada na barra de pesquisa está trazendo o resultado correto. |    |    |
...
| **ID** | **Descrição do teste** | **Descrição do resultado** | **Gravidade** |
|:---: |:---: |:---: |:---: |
| CT-17.1 - RF-05 | Verificar se a busca de interações por palavra chave digitada na barra de pesquisa está trazendo o resultado correto. |    |    |
...
| Registro da tela: | ![Postagem de Pergunta sem selecionar os campos “Categoria”, “Título” e "Conteúdo".](img/ct25postagemsempreenchereixocategoriamicro2.jpg) | Data do Teste: 06/05/2023 - Resultado: POSITIVO - O usuário consegue realizar a postagem de conteúdos sem selecionar os campos “Categoria”, “Título” e "Conteúdo". | Grave |
...
| Registro da tela: | ![Postagem de Pergunta sem selecionar os campos “Categoria”, “Título” e "Conteúdo".](img/ct25rf01postarconteúdosemeixocategoriaoumicrofundamento.jpg) | Data do Teste: 27/05/2023 - Resultado: NEGATIVO - O usuário não consegue realizar a postagem de conteúdos sem selecionar os campos “Categoria”, “Título” e "Conteúdo". | Sucesso |
| Registro da tela: | ![Postagem de Pergunta sem selecionar os campos “Categoria”, “Título” e "Conteúdo".](img/ct25rf01postarconteúdosemeixocategoriatitulo.png) | Data do Teste: 01/06/2023 - Resultado: NEGATIVO - O usuário não consegue realizar a postagem de conteúdos sem selecionar os campos “Categoria”, “Título” e "Conteúdo". | Sucesso |
...
| **ID** | **Descrição do teste** | **Descrição do resultado** | **Gravidade** |
|:---: |:---: |:---: |:---: |
| CT-35.1 - RF-08 | Verificar se a aplicação está apresentando todas as interações com os respectivos comentários para todos os usuários, logados ou não. ||  |
